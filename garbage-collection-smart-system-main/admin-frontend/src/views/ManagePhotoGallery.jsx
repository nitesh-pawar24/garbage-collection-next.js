...
const BASE_URL = (process.env.NEXT_PUBLIC_API_BASE_URL || "https://garbage-collection1.onrender.com/api")?.replace('/api', '') || 'http://localhost:10000'
...
export default function ManagePhotoGallery() {
  ...
  useEffect(() => {
    if (isUploadModalOpen) if (typeof window !== 'undefined') window.scrollTo({ top: 0, behavior: 'smooth' })
  }, [isUploadModalOpen])
